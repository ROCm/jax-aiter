...
ffi::Error MhaBwd_Bridge(
  ...
  auto args = aiter::mha_bwd_args{
      ...
      .d_ptr = softmax_d_ret->untyped_data(),
      .rand_val_ptr = nullptr,
      .dq_ptr = dq_ret->untyped_data(),
      .dk_ptr = dk_final,
      .dv_ptr = dv_final,
      .dbias_ptr = dbias_ptr,
      .dq_acc_ptr = dq_acc_ptr,

      .seqlen_q = static_cast<int>(seqlen_q),
      .seqlen_k = static_cast<int>(seqlen_k),
      .batch = static_cast<int>(batch_size),
      .max_seqlen_q = static_cast<int>(seqlen_q),
      .max_seqlen_k = static_cast<int>(seqlen_k),
      ...
      .stride_bias = static_cast<int>(stride_bias),
      ...
      .stride_dbias = static_cast<int>(stride_dbias),
      ...
      .batch_stride_q = static_cast<int>(batch_stride_q),
      .batch_stride_k = static_cast<int>(batch_stride_k),
      .batch_stride_v = static_cast<int>(batch_stride_v),
      .batch_stride_bias = 0,
      .batch_stride_o = static_cast<int>(batch_stride_o),
      .batch_stride_randval = 0,
      .batch_stride_do = static_cast<int>(batch_stride_do),
      .batch_stride_lsed = static_cast<int>(batch_stride_lse),
      .batch_stride_dq_acc = static_cast<int64_t>(batch_stride_dq_acc),
      .batch_stride_dq = static_cast<int>(batch_stride_dq),
      .batch_stride_dk = static_cast<int>(batch_stride_dk),
      .batch_stride_dv = static_cast<int>(batch_stride_dv),
